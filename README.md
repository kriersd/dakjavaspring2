...
1. `mvn install`
1. `java -jar ./target/dakjavaspring2-1.0-SNAPSHOT.jar`
...
* generator-ibm-java v5.12.3
* ibm-java-codegen-common v3.0.1
* generator-ibm-service-enablement v2.4.3
* generator-ibm-cloud-enablement v^1.1.4
